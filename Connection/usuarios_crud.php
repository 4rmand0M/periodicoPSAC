...
switch ($action) {
    ...
    case 'editar':
        ...
        // No permitir editar el propio rol de admin a editor
        if ($id == $_SESSION['user_id'] && $rol === 'editor') {
            echo json_encode(['success' => false, 'message' => 'No puedes cambiar tu propio rol de admin']);
            exit;
        }
